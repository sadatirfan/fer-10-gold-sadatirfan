            ...
            <div className="row">
              <div className="col-sm-12">
                <div className="card p-5">
                  <div className="row g-0">
                    <div className="col-md-4">
                      <img src="images/testi3_img_photo.png" className="img-fluid rounded-start" alt="Gambar 2" />
                    </div>
                    <div className="col-md-8">
                      <div className="card-body">
                        <h5 className="card-title">
            ...
            <div className="row">
              <div className="col-sm-12">
                <div className="card p-5">
                  <div className="row g-0">
                    <div className="col-md-4">
                      <img src="images/testi2_img_photo.png" className="img-fluid rounded-start" alt="Gambar 3" />
                    </div>
                    <div className="col-md-8">
                      <div className="card-body">
                        <h5 className="card-title">
