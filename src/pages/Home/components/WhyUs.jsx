      ...
      <Container className="pb-5 mb-5">
        ...
        <Row>
          <Col md-3 className="mt-3">
            <Card>
              <CardImg variant="top" src="images/icon_complete.png" className="ms-3 mt-3" />
              <Card.Body>
          ...
          <Col md-3 className="mt-3">
            <Card>
              <CardImg variant="top" src="images/icon_price.png" className="ms-3 mt-3" />
              <Card.Body>
          ...
          <Col md-3 className="mt-3">
            <Card>
              <CardImg variant="top" src="images/icon_24hrs.png" className="ms-3 mt-3" />
              <Card.Body>
          ...
          <Col md-3 className="mt-3">
            <Card>
              <CardImg variant="top" src="images/icon_professional.png" className="ms-3 mt-3" />
              <Card.Body>
