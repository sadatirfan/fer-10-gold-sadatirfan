...
export const SearchDetail = () => {
  ...
  const { car, name, status, category, minPrice, maxPrice } = location.state;
  const [carData, setCarData] = useState(null);

  const fetchCarData = async () => {
    try {
      const response = await axios.get(`https://bootcamp-rent-cars.herokuapp.com/customer/car/${car.id}`);
